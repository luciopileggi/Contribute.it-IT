...
<span data-ttu-id="acdad-121">Per creare citazioni, si usa il carattere `>`:</span><span class="sxs-lookup"><span data-stu-id="acdad-121">Blockquotes are created using the `>` character:</span></span>
...
<span data-ttu-id="acdad-164">verrà rappresentato nel modo seguente:</span><span class="sxs-lookup"><span data-stu-id="acdad-164">Will be rendered as:</span></span>
...
### <a name="code-snippets"></a><span data-ttu-id="acdad-191">Frammenti di codice</span><span class="sxs-lookup"><span data-stu-id="acdad-191">Code snippets</span></span>
...
|<span data-ttu-id="acdad-223">C#</span><span class="sxs-lookup"><span data-stu-id="acdad-223">C#</span></span>|<span data-ttu-id="acdad-224">csharp</span><span class="sxs-lookup"><span data-stu-id="acdad-224">csharp</span></span>|
...
|<span data-ttu-id="acdad-271">R</span><span class="sxs-lookup"><span data-stu-id="acdad-271">R</span></span>|<span data-ttu-id="acdad-272">r</span><span class="sxs-lookup"><span data-stu-id="acdad-272">r</span></span>|
...
#### <a name="example-sql"></a><span data-ttu-id="acdad-292">Esempio: SQL</span><span class="sxs-lookup"><span data-stu-id="acdad-292">Example: SQL</span></span>
...
<span data-ttu-id="acdad-307">Per l'elenco completo, vedere "Markdig e le estensioni Markdown" e "Frammenti di codice" nel sommario.</span><span class="sxs-lookup"><span data-stu-id="acdad-307">For the complete list, refer to "Markdig and Markdown extensions" and "Code snippets" in the table of contents.</span></span>
...
#### <a name="code-from-current-repository"></a><span data-ttu-id="acdad-364">Codice dal repository corrente</span><span class="sxs-lookup"><span data-stu-id="acdad-364">Code from current repository</span></span>
...
1. <span data-ttu-id="acdad-377">In Visual Studio Code fare clic su **ALT+M** o **Opzione+M** e selezionare Snippet (Frammento).</span><span class="sxs-lookup"><span data-stu-id="acdad-377">In Visual Studio Code, click **Alt + M** or **Option + M** and select Snippet.</span></span>
...
#### <a name="selected-line-numbers"></a><span data-ttu-id="acdad-392">Numeri di riga selezionati</span><span class="sxs-lookup"><span data-stu-id="acdad-392">Selected line numbers</span></span>
...
#### <a name="highlighting-selected-lines"></a><span data-ttu-id="acdad-405">Evidenziazione delle righe selezionate</span><span class="sxs-lookup"><span data-stu-id="acdad-405">Highlighting selected lines</span></span>
...
<span data-ttu-id="acdad-439">Il valore `try-dotnet-method` applica lo scaffolding a livello di metodi al codice passato al componente interattivo.</span><span class="sxs-lookup"><span data-stu-id="acdad-439">The `try-dotnet-method` value applies method-level scaffolding to the code passed to the interactive component.</span></span>
...
|<span data-ttu-id="acdad-466">Nome</span><span class="sxs-lookup"><span data-stu-id="acdad-466">Name</span></span>|<span data-ttu-id="acdad-467">Etichetta Markdown</span><span class="sxs-lookup"><span data-stu-id="acdad-467">Markdown label</span></span>|
|-----|-------|
...
#### <a name="code-extensions"></a><span data-ttu-id="acdad-503">Estensioni del codice</span><span class="sxs-lookup"><span data-stu-id="acdad-503">Code extensions</span></span>
...
|<span data-ttu-id="acdad-525">SQL</span><span class="sxs-lookup"><span data-stu-id="acdad-525">SQL</span></span>|<span data-ttu-id="acdad-526">sql</span><span class="sxs-lookup"><span data-stu-id="acdad-526">sql</span></span>|<span data-ttu-id="acdad-527">.sql</span><span class="sxs-lookup"><span data-stu-id="acdad-527">.sql</span></span>|
|<span data-ttu-id="acdad-528">VB</span><span class="sxs-lookup"><span data-stu-id="acdad-528">VB</span></span>|<span data-ttu-id="acdad-529">vb</span><span class="sxs-lookup"><span data-stu-id="acdad-529">vb</span></span>|<span data-ttu-id="acdad-530">.vb</span><span class="sxs-lookup"><span data-stu-id="acdad-530">.vb</span></span>|
|<span data-ttu-id="acdad-531">XAML</span><span class="sxs-lookup"><span data-stu-id="acdad-531">XAML</span></span>|<span data-ttu-id="acdad-532">xaml</span><span class="sxs-lookup"><span data-stu-id="acdad-532">xaml</span></span>|<span data-ttu-id="acdad-533">.xaml</span><span class="sxs-lookup"><span data-stu-id="acdad-533">.xaml</span></span>|
|<span data-ttu-id="acdad-534">XML</span><span class="sxs-lookup"><span data-stu-id="acdad-534">XML</span></span>|<span data-ttu-id="acdad-535">xml</span><span class="sxs-lookup"><span data-stu-id="acdad-535">xml</span></span>|<span data-ttu-id="acdad-536">.xml</span><span class="sxs-lookup"><span data-stu-id="acdad-536">.xml</span></span>|

## <a name="gotchas-and-troubleshooting"></a><span data-ttu-id="acdad-537">Problemi e risoluzione</span><span class="sxs-lookup"><span data-stu-id="acdad-537">Gotchas and troubleshooting</span></span>

### <a name="alt-text"></a><span data-ttu-id="acdad-538">Testo alternativo</span><span class="sxs-lookup"><span data-stu-id="acdad-538">Alt text</span></span>

<span data-ttu-id="acdad-539">Il testo alternativo che contiene caratteri di sottolineatura non viene visualizzato correttamente.</span><span class="sxs-lookup"><span data-stu-id="acdad-539">Alt text that contains underscores won't be rendered properly.</span></span> <span data-ttu-id="acdad-540">Ad esempio, invece di questa formattazione:</span><span class="sxs-lookup"><span data-stu-id="acdad-540">For example, instead of using this:</span></span>

```md
![ADextension_2FA_Configure_Step4](./media/bogusfilename/ADextension_2FA_Configure_Step4.PNG)
```

<span data-ttu-id="acdad-541">Usare caratteri di escape per i caratteri di sottolineatura come in questo esempio:</span><span class="sxs-lookup"><span data-stu-id="acdad-541">Escape the underscores like this:</span></span>

```md
![ADextension\_2FA\_Configure\_Step4](./media/bogusfilename/ADextension_2FA_Configure_Step4.PNG)
```

### <a name="apostrophes-and-quotation-marks"></a><span data-ttu-id="acdad-542">Apostrofi e virgolette</span><span class="sxs-lookup"><span data-stu-id="acdad-542">Apostrophes and quotation marks</span></span>

<span data-ttu-id="acdad-543">Quando si copia da Word in un editor per Markdown, il testo potrebbe contenere apostrofi o virgolette curve,</span><span class="sxs-lookup"><span data-stu-id="acdad-543">If you copy from Word into a Markdown editor, the text might contain "smart" (curly) apostrophes or quotation marks.</span></span> <span data-ttu-id="acdad-544">che devono essere codificati o modificati in semplici apostrofi o virgolette.</span><span class="sxs-lookup"><span data-stu-id="acdad-544">These need to be encoded or changed to basic apostrophes or quotation marks.</span></span> <span data-ttu-id="acdad-545">In caso contrario, quando il file viene pubblicato, si ottiene questo risultato: Itâ€™s</span><span class="sxs-lookup"><span data-stu-id="acdad-545">Otherwise, you end up with things like this when the file is published: Itâ€™s</span></span>

<span data-ttu-id="acdad-546">Queste sono le codifiche per le versioni curve di questi segni di punteggiatura:</span><span class="sxs-lookup"><span data-stu-id="acdad-546">Here are the encodings for the "smart" versions of these punctuation marks:</span></span>

- <span data-ttu-id="acdad-547">Virgolette (aperte) a sinistra: `&#8220;`</span><span class="sxs-lookup"><span data-stu-id="acdad-547">Left (opening) quotation mark: `&#8220;`</span></span>
- <span data-ttu-id="acdad-548">Virgolette (chiuse) a destra: `&#8221;`</span><span class="sxs-lookup"><span data-stu-id="acdad-548">Right (closing) quotation mark: `&#8221;`</span></span>
- <span data-ttu-id="acdad-549">Virgoletta singola (chiusa) a destra o apostrofo: `&#8217;`</span><span class="sxs-lookup"><span data-stu-id="acdad-549">Right (closing) single quotation mark or apostrophe: `&#8217;`</span></span>
- <span data-ttu-id="acdad-550">Virgoletta singola (aperta) a sinistra (usata raramente): `&#8216;`</span><span class="sxs-lookup"><span data-stu-id="acdad-550">Left (opening) single quotation mark (rarely used): `&#8216;`</span></span>

### <a name="angle-brackets"></a><span data-ttu-id="acdad-551">Parentesi acute</span><span class="sxs-lookup"><span data-stu-id="acdad-551">Angle brackets</span></span>

<span data-ttu-id="acdad-552">Le parentesi acute vengono comunemente usate per indicare un segnaposto.</span><span class="sxs-lookup"><span data-stu-id="acdad-552">It is common to use angle brackets to denote a placeholder.</span></span> <span data-ttu-id="acdad-553">Se usate nel testo e non nel codice, le parentesi acute devono essere codificate.</span><span class="sxs-lookup"><span data-stu-id="acdad-553">When you do this in text (not code), you must encode the angle brackets.</span></span> <span data-ttu-id="acdad-554">In caso contrario, Markdown le interpreta come tag HTML.</span><span class="sxs-lookup"><span data-stu-id="acdad-554">Otherwise, Markdown thinks that they're intended to be an HTML tag.</span></span>

<span data-ttu-id="acdad-555">Ad esempio, codificare `<script name>` come `&lt;script name&gt;`</span><span class="sxs-lookup"><span data-stu-id="acdad-555">For example, encode `<script name>` as `&lt;script name&gt;`</span></span>

## <a name="markdown-flavor"></a><span data-ttu-id="acdad-556">Versione di Markdown</span><span class="sxs-lookup"><span data-stu-id="acdad-556">Markdown flavor</span></span>

<span data-ttu-id="acdad-557">Il back-end del sito docs.microsoft.com supporta il Markdown conforme a [CommonMark](https://commonmark.org/) analizzato tramite il motore di analisi [Markdig](https://github.com/lunet-io/markdig).</span><span class="sxs-lookup"><span data-stu-id="acdad-557">The docs.microsoft.com site backend supports [CommonMark](https://commonmark.org/) compliant Markdown parsed through the [Markdig](https://github.com/lunet-io/markdig) parsing engine.</span></span> <span data-ttu-id="acdad-558">Questa versione di Markdown è per lo più compatibile con [GitHub Flavored Markdown (GFM)](https://help.github.com/categories/writing-on-github/), perché la maggior parte dei documenti viene archiviata in GitHub dove può essere modificata.</span><span class="sxs-lookup"><span data-stu-id="acdad-558">This markdown flavor is mostly compatible with [GitHub Flavored Markdown (GFM)](https://help.github.com/categories/writing-on-github/), as most docs are stored in GitHub and can be edited there.</span></span> <span data-ttu-id="acdad-559">Altre funzionalità vengono aggiunte tramite le estensioni per Markdown.</span><span class="sxs-lookup"><span data-stu-id="acdad-559">Additional functionality is added through Markdown extensions.</span></span>

## <a name="see-also"></a><span data-ttu-id="acdad-560">Vedere anche:</span><span class="sxs-lookup"><span data-stu-id="acdad-560">See also:</span></span>

### <a name="markdown-resources"></a><span data-ttu-id="acdad-561">Risorse per Markdown</span><span class="sxs-lookup"><span data-stu-id="acdad-561">Markdown resources</span></span>

- <span data-ttu-id="acdad-562">[Introduction to Markdown](https://daringfireball.net/projects/markdown/syntax) (Introduzione a Markdown)</span><span class="sxs-lookup"><span data-stu-id="acdad-562">[Introduction to Markdown](https://daringfireball.net/projects/markdown/syntax)</span></span>
- <span data-ttu-id="acdad-563">[Docs Markdown cheat-sheet](./media/documents/markdown-cheatsheet.pdf?raw=true) (Scheda informativa su Markdown per Docs)</span><span class="sxs-lookup"><span data-stu-id="acdad-563">[Docs Markdown cheat sheet](./media/documents/markdown-cheatsheet.pdf?raw=true)</span></span>
- [<span data-ttu-id="acdad-564">Nozioni di base su Markdown in GitHub</span><span class="sxs-lookup"><span data-stu-id="acdad-564">GitHub's Markdown Basics</span></span>](https://help.github.com/articles/markdown-basics/)
- [<span data-ttu-id="acdad-565">Guida Markdown</span><span class="sxs-lookup"><span data-stu-id="acdad-565">The Markdown Guide</span></span>](https://www.markdownguide.org/)
